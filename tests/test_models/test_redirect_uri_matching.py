...
class TestRedirectURIMatching:
    def test_exact_match(self):
        client_config = ClientConfig(redirect_uris='http://my-site.com/auth/complete')
    ...
    def test_match_with_param_with_value(self):
        client_config = ClientConfig(redirect_uris='http://my-site.com/auth/complete?a=2')
    ...
    def test_match_with_param(self):
        client_config = ClientConfig(redirect_uris='http://my-site.com/auth/complete?a')
        assert client_config.check_redirect_url('http://my-site.com/auth/complete?a=2')
